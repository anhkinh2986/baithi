<template>
  <div style="min-height: 84.6vh;">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div class="container-fluid">
        <router-link class="navbar-brand" to="/"><img src="../src/image/R.png" alt="Logo" style="width:100px;" class="rounded-pill"></router-link>
        <button
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            <li class="nav-item">
              <router-link class="nav-link fs-5" to="/">Trang chủ</router-link>
            </li>
            <li class="nav-item" v-if="isLoggedIn">
              <router-link class="nav-link fs-5" to="/profile">Hồ sơ</router-link>
            </li>
            <li class="nav-item" v-if="isLoggedIn">
              <router-link class="nav-link fs-5" to="/create-post">Tạo bài viết</router-link>
            </li>
          </ul>
          <ul class="navbar-nav ms-auto">
            <li class="nav-item" v-if="!isLoggedIn">
              <router-link class="nav-link fs-5" to="/login">Đăng nhập</router-link>
            </li>
            <li class="nav-item" v-if="!isLoggedIn">
              <router-link class="nav-link fs-5" to="/register">Đăng ký</router-link>
            </li>
            <!-- <li class="nav-item" v-if="isLoggedIn">
              <router-link class="nav-link fs-5" to="/profile">Hồ sơ</router-link>
            </li>
            ...
            <li class="nav-item" v-if="isLoggedIn">
              <a class="nav-link fs-5" href="#" @click="logout">Đăng xuất</a>
            </li>
          </ul>
        </div>
      </div>
  ...
  <footer class="bg-light text-center text-white mt-4">
    ...
    <div class="text-center p-3" style="background-color: #28242c;">
        ...
        <a
            ...
            href="#!"
            role="button"
            ><i class="fab fa-facebook-f"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0,0,256,256">
        ...
        <a
            ...
            href="#!"
            role="button"
            ><i class="fab fa-twitter"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0,0,256,256">
        ...
        <a
            ...
            href="#!"
            role="button"
            ><i class="fab fa-google"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0,0,256,256">
        ...
        <a
            ...
            href="#!"
            role="button"
            ><i class="fab fa-instagram"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0,0,256,256">
        ...
        <a
            ...
            href="#!"
            role="button"
            ><i class="fab fa-github"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0,0,256,256">
        ...
        <span>© 2020 Copyright: <span>Porsche</span></span>
